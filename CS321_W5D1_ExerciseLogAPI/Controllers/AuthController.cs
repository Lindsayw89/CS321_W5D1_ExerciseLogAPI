...
namespace CS321_W5D1_ExerciseLogAPI.Controllers
{
    ...
    public class AuthController : Controller
    {
        ...
        //  Prep Part 1: add constructor and inject UserManager 
        public AuthController(UserManager<User> userManager, IConfiguration configuration)
        {
            _userManager = userManager;
            _config = configuration;
        }
        //  Prep Part 2: inject IConfiguration in the constructor
        ...
        //  Prep Part 1: Add a Registration Action (Part 1 of Prep exercise)

        // T Prep Part 2: Add a login action (Part 2 of Prep exercise)
        // POST api/auth/login
        [AllowAnonymous]
        [HttpPost("login")]
